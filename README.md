...
1. Had some issue with adding the logout button to the navbar controller, since I embedded a tabbar controller at the start of the assignment, but  figured it out with some help from TA.
2. 
...
- [ ] List anything else that you can get done to improve the app functionality!
- [x] Added a border color and width to the text view to be able to intuitively see that we can click on it for editing.

Please list two areas of the assignment you'd like to **discuss further with your peers** during the next class (examples include better ways to implement something, how to extend your app in certain ways, etc):

1. Had trouble with navigation controller and tab bar controller parent-child relationship which caused some problems for the logout button on the top left, it would not leave even when i clicked on different tabs.
2. Whenever I tweeted, I had trouble getting off the compose tweet controller.

## Video Walkthrough

Here's a walkthrough of implemented user stories:

<img src='https://i.imgur.com/hTr4HWv.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />
